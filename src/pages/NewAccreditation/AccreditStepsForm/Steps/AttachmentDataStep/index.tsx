  ...
  return (
    <Div sx={{ padding: 2 }}>
      <Paper sx={{ padding: 2 }}>
            ...
            >
              <Box sx={{ alignSelf: 'center', position: 'relative' }}>
                ...
                <Tooltip title="Remover">
                  <Box
                    component="span"
                    sx={{ marginTop: 1, cursor: 'pointer', display: 'block' }}
                    onClick={() => removeFile(file)}
                  >
                    <Label variant="body2">Remover anexo</Label>
                  </Box>
                </Tooltip>
              </Box>
            </Box>
        ...
        {errors.attachmentDataStep?.attachmentData?.files && (
          <FormHelperText error>{errors.attachmentDataStep?.attachmentData?.files.message}</FormHelperText>
        )}
      </Paper>
